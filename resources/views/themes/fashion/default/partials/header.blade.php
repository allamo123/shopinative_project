    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                <a href="{{route('shop.frontend')}}">
                    <img src="{{ asset('themes/fashion/default/images/logo.svg') }}"
            ...
            <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                ...
                <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                    <ul id="siteNav" class="site-nav medium center hidearrow">
                        ...
                        <li class="lvl1 parent megamenu">
                            <a href="{{ route('shop.products') }}">Shop <i class="anm anm-angle-down-l"></i></a>
                            {{-- <div class="megamenu style4">
                                <ul class="grid grid--uniform mmWrapper">
                                    ...
                                    <li class="grid__item lvl-1 col-md-6 col-lg-6">
                                        <a href="#"><img
                                                src="{{ asset('themes/fashion/default/images/megamenu-bg1.jpg') }}"
                                                alt="" title="" /></a>
                                    </li>
                                </ul>
                            </div> --}}
                            ...
                            <div class="megamenu style2">
                                <ul class="grid mmWrapper">
                                    ...
                                    <li class="grid__item large-up--one-whole imageCol"><a href="#"><img
                                                src="{{ asset('themes/fashion/default/images/megamenu-bg2.jpg') }}"
                                                alt=""></a></li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{ asset('themes/fashion/default/images/logo.svg') }}" alt="Belle Multipurpose Html Template"
                        ...
                        <ul class="mini-products-list">
                            <li class="item">
                                <a class="product-image" href="#">
                                    <img src="{{ asset('themes/fashion/default/images/product-images/cape-dress-1.jpg') }}"
                            ...
                            <li class="item">
                                <a class="product-image" href="#">
                                    <img src="{{ asset('themes/fashion/default/images/product-images/cape-dress-2.jpg') }}"
